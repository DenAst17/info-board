  ...
  mounted() {
    ...
    onAuthStateChanged(auth, (user) => {
      if (user) {
        ...
        this.isLogin = true;
        if (user.displayName) {
          ((this.$refs.userName as any).textContent as string | null) =
            user.displayName; // what is a type of this.$refs.userName
        } else {
          ((this.$refs.userName as any).textContent as string | null) =
            user.email; // what is a type of this.$refs.userName
        }
